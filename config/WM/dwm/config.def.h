...
static const int vertpad                 = 40;  /* vertical padding of bar */
...
static const char *rofi_launcher[] =  { "/home/kc/.config/rofi/launchers/type-1/launcher.sh", NULL };
...
{ Mod1Mask|ShiftMask,           XK_Print,  spawn,          SHCMD("scrot '/home/kc/Pictures/Screenshots/%Y-%m-%d-%H-%M-%S.png'") },
